#!/bin/bash
CUDA_VISIBLE_DEVICES=0,1,2 CUDA_LAUNCH_BLOCKING=1 python3 main_pretrain.py --dataset cifar100  --no_labels \
    --backbone resnet18 \
    --data_dir datasets \
    --max_epochs 1000 \
    ...
    --momentum_classifier --color_jitter_prob 0.8 --seed ${1}
